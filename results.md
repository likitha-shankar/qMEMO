Results                                                                                                                                                                                    
  ...
  Cores  |  Throughput   |  Per-thread  |  Speedup  |  Efficiency
     1   |   6,111 ops/s |  6,111 /thr  |   1.00×   | 100.0%                                                                                                                                 
     2   |  13,707 ops/s |  6,853 /thr  |   2.24×   | 112.2%
     4   |  26,762 ops/s |  6,691 /thr  |   4.38×   | 109.5%
     6   |  39,632 ops/s |  6,605 /thr  |   6.49×   | 108.1%
     8   |  40,889 ops/s |  5,111 /thr  |   6.69×   |  83.6%
    10   |  44,985 ops/s |  4,499 /thr  |   7.36×   |  73.6%
  ...
  The headline result: Falcon-512 is the fastest verifier in the entire suite — including both classical schemes. At 44,643 verify/sec it beats Ed25519 (12,641) by 3.5× and ECDSA (5,643) by
   7.9×. For a blockchain where blocks are verified by all nodes on every incoming transaction, this is the single most important number.

  The keygen surprise: Falcon-512 keygen is only 213 ops/sec — the worst in the suite by a large margin. ML-DSA-44 keygens 168× faster. This isn't a problem for blockchain use (keys are
