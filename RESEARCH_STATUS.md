...
| `statistical_benchmark` | 1,000 trials × 100 ops; mean, median, std dev, CV, Jarque-Bera normality test |
...
ML-DSA-44 by 17% and classical Ed25519 by 3.5×. Verification-heavy workloads (e.g., block
...
**Ed25519 is the fastest signer** overall (34,335 ops/sec) — roughly 5× faster than ML-DSA-44
sign and 4.9× faster than Falcon-512 sign. The signing cost is the main penalty for Falcon
in signing-heavy workloads.

**SLH-DSA-SHA2-128f signing is 52 ops/sec** — roughly 660× slower than Ed25519 sign. Its
...
**Falcon-512 multicore signing scales 8.6× from 1→10 cores** (6,122 → 52,702 ops/sec at 86%
